...
- 72 unit tests covering text cleanup, URL cleaning, Markdown conversion, smart detection, image OCR formatting, PDF/RTF clipboard extraction, clipboard history, table detection, and bold formatting.
